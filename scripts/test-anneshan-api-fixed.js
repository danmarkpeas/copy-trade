...
// Delta Exchange API functions with fixed signature generation
...
async function testAnneshanAPI() {
  console.log('🧪 TESTING ANNESHAN FOLLOWER API CREDENTIALS (FIXED)');
  console.log('====================================================\n');
  ...
  try {
    ...
    // Test 1: Get wallet balances (most reliable endpoint)
    ...
    if (balancesResult.success) {
      ...
      console.log(`   Response: ${balancesResult.responseText}`);
    }
    console.log('');
